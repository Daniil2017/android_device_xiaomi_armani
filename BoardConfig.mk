...
TARGET_BOARD_CFLAGS += -mfpu=neon -mfloat-abi=softfp
TARGET_BOARD_CPPFLAGS += -mfpu=neon -mfloat-abi=softfp
...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.bootdevice=msm_sdcc.1 androidboot.hardware=armani user_debug=31 msm_rtb.filter=0x37 androidboot.selinux=permissive
BOARD_KERNEL_BASE := 0x00000000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100
KERNEL_TOOLCHAIN := $(ANDROID_BUILD_TOP)/prebuilts/gcc/linux-x86/arm/arm-cortex_a7-linux-gnueabihf-linaro_4.9/bin
...
COMMON_BOARD_CFLAGS += -DNO_SECURE_DISCARD
TWHAVE_SELINUX := true
...
#	RIL
COMMON_BOARD_CFLAGS += -DUSE_RIL_VERSION_10
COMMON_BOARD_CPPFLAGS += -DUSE_RIL_VERSION_10
SIM_COUNT := 2
